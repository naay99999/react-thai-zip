  ...
  return (
    <div className={cn('relative w-full', className)}>
      <Popover open={open} onOpenChange={setOpen}>
        ...
        {/* Radix exposes the trigger width as --radix-popover-trigger-width;
            the Base UI copy of this file uses --anchor-width instead. */}
        <PopoverContent align="start" className={cn('w-[var(--radix-popover-trigger-width)] p-0', popupClassName)}>
