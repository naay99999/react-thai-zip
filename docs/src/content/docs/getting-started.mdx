...
ต่อไป ดูคู่มือ [cascade select](/react-thai-zip/components/cascade-select/) เพื่อเลือก UI สำหรับการกรอกที่อยู่ตามลำดับ ส่วนคู่มือฟอร์มจะอธิบายการส่งค่าในภายหลัง
