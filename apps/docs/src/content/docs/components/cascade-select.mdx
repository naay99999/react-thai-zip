...
คำสั่งจะเพิ่มคอมโพเนนต์ รวมถึง `utils` และ hook สำหรับโหลดดัชนีที่อยู่ลงในตำแหน่งที่บันทึกไว้ใน [`thaizip.config.json`](/react-thai-zip/reference/config/)
...
ดู [การใช้งานร่วมกับฟอร์ม](/react-thai-zip/guides/forms/) สำหรับการส่งค่าที่อยู่ และ [การปรับแต่ง](/react-thai-zip/guides/customization/) สำหรับปรับหน้าตา ถ้าต้องการค้นหาจากข้อความ ดู [autocomplete](/react-thai-zip/components/autocomplete/)
