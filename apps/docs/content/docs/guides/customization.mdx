...
ขั้นตอนนี้จำเป็นสำหรับ Tailwind v3 ก่อนที่ token classes ของคอมโพเนนต์จะ resolve ได้ หาก classes ยังไม่มี style ให้ตรวจตาม [การแก้ปัญหา Tailwind v3](/docs/troubleshooting#tailwind-v3-ไม่มี-styles-ของ-token)
...
ดู [การใช้งานร่วมกับฟอร์ม](/docs/guides/forms) สำหรับ `name`, hidden fields และ validation semantics
