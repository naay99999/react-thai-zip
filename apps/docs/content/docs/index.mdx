...
ดูวิธีใช้ [autocomplete](/docs/components/autocomplete) หรือ [cascade select](/docs/components/cascade-select) ในสถานการณ์ต่าง ๆ และดูข้อมูลดัชนีและ API ระดับล่างได้ที่ [thai-zip Core API](https://naay99999.github.io/thai-zip/)
